        ...
        >
            ...
            <div className="py-6">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-4">
                        <Link href={route('admin.types.index')} className="btn btn-outline btn-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {/* Asset Sub-types List */}
                        <div className="card bg-base-100 shadow-xl md:col-span-2">
                            <div className="card-body">
                                <div className="flex justify-between items-center">
                                    <h3 className="card-title text-base-content">Asset Sub-types</h3>
                                    <div className="flex gap-2">
                                        ...
                                        <Link href={route('admin.types.sub-types.create', assetType.id)}>                                      <button type="button" className="btn btn-primary btn-sm">
