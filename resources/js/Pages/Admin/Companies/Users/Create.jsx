...
import { FiArrowLeft, FiUser, FiMail, FiLock, FiBriefcase, FiImage } from 'react-icons/fi';

export default function Create({ auth, company, roles, permissionGroups }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.companies.users.store', company.id), {
            onSuccess: () => reset(),
        });
    };
    ...
    return (
        ...
        >
            <Head title={`Add User to ${company.name}`} />
