...
export default function FleetEdit({ fleet }) {
    const { data, setData, put, processing, errors } = useForm({
        name: fleet.name || '',
        description: fleet.description || '',
        manager_name: fleet.manager_name || '',
        manager_email: fleet.manager_email || '',
        manager_phone: fleet.manager_phone || '',
    ...
    const submit = (e) => {
        ...
        put(route('company.fleets.update', fleet.id), {
            onSuccess: () => {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-base-content leading-tight">Edit Fleet</h2>
                </div>
            }
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="mb-6 flex justify-between">
                        ...
                        <Link href={route('company.fleets.show', fleet.id)} className="btn btn-outline btn-sm">
                            View Fleet Details
                        </Link>
                    </div>
