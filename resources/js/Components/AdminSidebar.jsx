...
export default function AdminSidebar() {
    ...
    return (
        <div className="h-screen w-80 bg-base-100 text-base-content border-r border-base-300 flex flex-col">
            ...
            <div className="px-4 py-3 border-b border-base-300">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <div className="text-nav font-medium">{user.name}</div>
            ...
            <div className="flex-1 overflow-y-auto px-2 py-2">
                <ul className="menu w-72 pt-2 bg-base-100 min-h-full text-base-content">
            ...
            <div className="px-4 py-2 text-xs opacity-50 border-t border-base-300">
                <div className="text-indicator">Carbon Credit v1.0.0</div>
